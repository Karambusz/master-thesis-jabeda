...
import {getResource, postData} from "../util/http";
import {
    validateAddressField,
    validateEmailField,
    validatePasswordField,
    validatePhoneField, validateStringFields
...
const SignUp = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const data = {
            ...
            buildingNumber: address.split(",")[1],
    ...
    return (
        <div className="sign-up-wrapper">
            <h2 className="sign-up-header">Rejestracja użytkownika</h2>
